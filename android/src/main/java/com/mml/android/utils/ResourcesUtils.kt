...
object ResourcesUtils {
    ...
    fun getDrawableResources(context: Context, drawableName: String): Int =
        context.getResourcesId(drawableName, "drawable")
    ...
    private fun Context.getResourcesId(resourcesName: String, defType: String): Int =
        this.resources.getIdentifier(resourcesName, defType, this.packageName)
