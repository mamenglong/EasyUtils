...
class AESUtils {
    companion object {
        ...
        fun encrypt(var2: String): String {
            ...
            result = Base64.encode(result).toByteArray()
        ...
        fun decrypt(var2: String): String {
            ...
            return bytesToString(var4.doFinal(var2.toByteArray()))
        }
