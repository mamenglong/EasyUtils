package com.mml.java.data;

/**
 * 项目名称：EasyUtils
 * Created by Long on 2019/4/11.
 * 修改时间：2019/4/11 13:07
 */
...
public final class Base64 {
    ...
    public static String decode(String var0) {
        byte[] ss = decode(var0.getBytes(), var0.getBytes().length);
        return bytesToString(ss);
    }
    ...
    public static String encode(byte[] var0) throws UnsupportedEncodingException {
        return encode(var0, "utf-8");
    }

    public static String encode(String var0) throws UnsupportedEncodingException {
